    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4">{text.quickLinks[language]}</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.home[language]}</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.report[language]}</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.dashboard[language]}</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.about[language]}</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.careers[language]}</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">{text.links.privacy[language]}</a></li>
            </ul>
          </div>

          {/* Contact Information */}
          <div>
            <h4 className="text-lg font-semibold mb-4">{text.contact[language]}</h4>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium">
                    {language === 'en' ? 'Rail Bhavan, New Delhi' : 'रेल भवन, नई दिल्ली'}
                  </p>
                  <p className="text-sm text-gray-300">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-gray-400 text-sm">
                {language === 'en' ? 'Powered by Digital India Initiative' : 'डिजिटल इंडिया पहल द्वारा संचालित'}
              </span>
